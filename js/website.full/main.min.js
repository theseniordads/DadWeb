...
$("#saggie .title").each(function(){$(this).attr("title","sAgG13!!!1!");$(this).click(function(){window.location="/default.html"})});$(".more").each(function(){$(this).attr("title","[ m0R3!!!11!1 ]");$(".link").click(function(){window.location=$(this).attr("rel")})})});
